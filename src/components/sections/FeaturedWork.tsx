...
// //             transition-colors
// //             duration-300
// //             hover:border-[#6495ED]/50
// //             transform-gpu
// //           "
// //         >
// //           {/* Top Image Section */}
// //           <div className="relative h-[200px] w-full shrink-0 border-b border-[#1E293B] bg-[#131B2B]">
// //             {image ? (
// //               <Image
// //                 src={image}
// //                 alt={brand}
...
// //             <div className="pointer-events-none absolute inset-0 z-10 bg-gradient-to-br from-[#6495ED]/10 via-transparent to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
// //           </div>

// //           {/* Bottom Content Section */}
// //           <div className="relative z-20 flex flex-1 flex-col p-6 bg-[#0F1523]">
// //             {/* Category / Industry */}
// //             <span className="mb-2 text-[11px] font-bold uppercase tracking-wider text-[#6495ED]">
// //               {industry || "Retail"}
// //             </span>

// //             {/* Title / Brand */}
// //             <h3 className="mb-1 text-2xl font-bold text-white line-clamp-1">
// //               {brand}
// //             </h3>

// //             {/* Sales Figure / Result */}
// //             <p className="mb-8 text-[15px] text-gray-400 font-medium line-clamp-2">
// //               {result}
// //             </p>

// //             {/* Footer Action */}
// //             <div className="mt-auto flex items-center gap-2 text-sm font-bold text-white transition-colors group-hover:text-[#6495ED]">
// //               View Case Study
...
// //           {/* LEFT COLUMN: Text (Adjusted width to give cards more space) */}
// //           <motion.div
// //             initial={{ opacity: 0, x: -20 }}
// //             whileInView={{ opacity: 1, x: 0 }}
// //             viewport={{ once: true, amount: 0.3 }}
// //             transition={{ duration: 0.7 }}
// //             className="flex flex-col items-start lg:w-[30%] xl:w-[25%] shrink-0"
// //           >
...
// //           {/* RIGHT COLUMN: Scrollable Cards Grid (Given wider area so 3 cards fit perfectly) */}
// //           <div className="flex w-full flex-col lg:w-[70%] xl:w-[75%] relative group/slider">
...
// //                   <button
// //                     onClick={scrollLeft}
// //                     className="absolute -left-2 md:-left-6 top-[42%] z-20 hidden md:flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border-2 border-gray-300 bg-white/40 backdrop-blur-md shadow-sm transition-all hover:border-[#6495ED] hover:text-[#6495ED] hover:scale-110"
...
// //                     {/* Width set to exactly 280px so 3 cards perfectly fill the right side without cutting */}
// //                     <div key={project.id} className="w-[85vw] sm:w-[280px] shrink-0 snap-center h-[420px]">
// //                       <TiltCard
// //                         brand={project.brand}
// //                         industry={project.industry}
// //                         result={project.result}
...
// //                   <button
// //                     onClick={scrollRight}
// //                     className="absolute -right-2 md:-right-6 top-[42%] z-20 hidden md:flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border-2 border-gray-300 bg-white/40 backdrop-blur-md shadow-sm transition-all hover:border-[#6495ED] hover:text-[#6495ED] hover:scale-110"
...
//           {/* Bottom Content Section (Precisely matched to the uploaded screenshot) */}
//           <div className="relative z-20 flex flex-1 flex-col p-7 bg-[#0B101A]">
//             {/* Category / Industry */}
...
//             {/* Title / Brand */}
//             <h3 className="mb-1 text-[22px] font-bold text-white tracking-tight line-clamp-1">
//               {brand}
//             </h3>

//             {/* Sales Figure / Result */}
//             <p className="mb-8 text-[15px] text-[#8B95A5] font-medium line-clamp-2">
//               {result}
//             </p>

//             {/* Footer Action */}
//             <div className="mt-auto flex items-center gap-2 text-[15px] font-bold text-white transition-colors group-hover:text-[#5C89F8]">
//               View Case Study
...
//                 >
//                   {projects.map((project) => (
//                     <div key={project.id} className="w-[85vw] sm:w-[280px] shrink-0 snap-center h-[440px]">
//                       <TiltCard
//                         brand={project.brand}
//                         industry={project.industry}
//                         result={project.result}
