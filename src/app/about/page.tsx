  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        {/* ========================================= */}
        <section className="relative flex min-h-[70vh] flex-col justify-center bg-white px-6 pt-32 pb-20 md:pt-40 md:pb-32">
          <div className="mx-auto w-full max-w-7xl">
            <motion.div
              initial="hidden"
              animate="visible"
            ...
            >
              ...
              <motion.h1 variants={fadeUpVariant} className="mt-6 text-4xl font-bold tracking-tight text-[#0A0A0A] md:text-6xl lg:text-7xl">
                We are a team of specialists delivering <span className="text-[#6495ED]">award-winning</span> work.
              </motion.h1>
              <motion.p variants={fadeUpVariant} className="mt-8 max-w-2xl text-lg leading-relaxed text-gray-600 md:text-xl">
                We believe in the power of digital experiences to transform businesses, elevate brands, and connect with people on a global scale.
              </motion.p>
            </motion.div>
          </div>
