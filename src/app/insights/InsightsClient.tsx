...
import { ArrowRight, ArrowUpRight, ChevronDown, Send } from "lucide-react";
      ...
      <main className="min-h-screen bg-[#FAFAFA]">
        ...
        <section className="mx-auto max-w-7xl px-6 py-10 border-b border-gray-200">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            {/* Custom Sort Dropdown (Stacked dark style matched to image) */}
        ...
        {/* 3. UNIFIED INSIGHTS GRID (Strictly proportioned) */}
