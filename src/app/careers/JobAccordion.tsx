...
// import { ChevronDown, ChevronUp, MapPin, Clock, Briefcase, FileText } from "lucide-react";
...
//                       </button>
//                       <button className="rounded-md bg-[#0056b3] px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#004494] shadow-sm">
//                         Apply Now
//                       </button>
//                     </div>
//                   </div>
                ...
                >
                  <div className="border-t border-gray-100 p-6 pt-4 text-gray-700">
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row mt-6">
                      ...
                      {/* FIXED: Changed to an <a> tag pointing to the mailto link */}
                      <a 
                        href={applyLink}
                        className="inline-flex items-center justify-center rounded-md bg-[#0056b3] px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#004494] shadow-sm"
                      >
                        Apply Now
                      </a>
                    </div>
